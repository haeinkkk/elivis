...
export function AccountSuspendedClient() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-stretch justify-center bg-[#f8f7f5] px-4 py-8 sm:px-6 md:px-8">
            <div className="mx-auto w-full max-w-3xl">
                <div className="mb-6 text-center sm:mb-8">
                    <span className="inline-block font-sans text-3xl font-semibold tracking-tight text-stone-800 sm:text-4xl md:text-5xl">
                        Elivis
                    </span>
                </div>
                ...
                <div className="overflow-hidden rounded-2xl border border-stone-200/80 bg-white shadow-sm shadow-stone-200/50">
                    ...
                    <div className="space-y-4 px-5 py-8 sm:px-8 sm:py-10 md:px-10 md:py-12">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4">
                            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-red-50 sm:h-12 sm:w-12">
                                <svg
                                    className="h-6 w-6 text-red-600 sm:h-7 sm:w-7"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    strokeWidth={1.5}
                                    stroke="currentColor"
                        ...
                        {reasonText ? (
                            <div className="rounded-xl border border-stone-200 bg-stone-50/80 px-4 py-3 sm:px-5 sm:py-4">
                                <p className="text-xs font-semibold uppercase tracking-wide text-stone-500">
                                    {t("reasonHeading")}
                                </p>
                                <p className="mt-2 whitespace-pre-wrap break-words text-sm leading-relaxed text-stone-800 sm:text-base">
                                    {reasonText}
                                </p>
                            </div>
                        ) : null}
